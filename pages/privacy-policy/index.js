...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-[#f8fafc] text-[#1a2e2e]">
      <Head>
        <title>Privacy Policy | Welsh Mole Catcher</title>
        <meta name="description" content="Privacy Policy for Welsh Mole Catcher." />
      ...
      <main className="container mx-auto px-6 py-20 max-w-5xl">
        <h1 className="text-4xl font-bold mb-12 text-[#1a3c34]">Privacy Policy</h1>
        <p className="text-lg text-[#4a4a4a] leading-relaxed">
          This is the privacy policy for Welsh Mole Catcher. We are committed to protecting your personal information.
        </p>
